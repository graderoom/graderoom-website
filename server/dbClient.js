...
const _internalApiDiscordConnect = async (db, username, discordID, discordName, avatar) => {
    ...
    let notification = {
        ...
        message: `Connecting ${chip ?? "your Discord account"}<br>Enter the 2-Digit Code sent by Graderoomba ${notificationTextField("discord-verify", `sendData("discord-verify", {verificationCode: $("#discord-verify")[0].valueAsNumber})`, "number", "2-Digit Code", "10", "99", "1")}`,
        dismissible: true,
        dismissed: false,
        important: true,
        pinnable: false,
